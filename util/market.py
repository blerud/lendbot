...
def get_intraday_graph(symbol):
    ...
    ax.xaxis.set_major_formatter(mdates.DateFormatter("%I %p", tz=pytz.timezone('America/New_York')))
    ax.xaxis.set_minor_formatter(mdates.DateFormatter("%I %p", tz=pytz.timezone('America/New_York')))
